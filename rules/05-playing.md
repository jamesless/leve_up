...
**甩牌失败时的选择权**：
- 如果只有一种牌型被管上，甩牌者直接保留该牌型
- 如果有多种牌型被管上，**最靠近甩牌者的玩家**（逆时针第一个能管上的玩家）可以选择让甩牌者留哪个牌型
- 选择界面显示可选的牌型，玩家点击选择
...
**游戏界面提示**（甩牌失败时）：
- 显示："玩家X的[牌型]管上了你的[牌型]"
- 如果有多种牌型被管上，显示选择界面："请选择让甩牌者保留哪个牌型"
