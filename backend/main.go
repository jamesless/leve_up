...
func main() {
	...
	api := r.Group("/api")
	{
		...
		protected.Use(middleware.AuthMiddleware())
		{
			...
			protected.POST("/game/:id/ready", handlers.PlayerReadyHandler)
			protected.POST("/game/:id/cancel-ready", handlers.PlayerCancelReadyHandler)
			protected.GET("/game/:id/ready-status", handlers.GetReadyStatusHandler)
			protected.POST("/game/:id/deal-next", handlers.DealNextCardHandler)
